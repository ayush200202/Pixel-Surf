...
if($cm['from_user_id']==$_SESSION['userdata']['id']){
    ...
    $chatmsg.=' <div class="py-2 px-3 border rounded shadow-sm col-8 d-inline-block '.$cl1.'" style="background-color:lightgreen">'.$cm['msg'].'<br>
    <span style="font-size:small;color:black" class="'.$cl2.'">'.gettime($cm['created_at']).'</span>
</div>';
}
