<?php global $user;?>
    <nav class="navbar navbar-expand-lg navbar-light border" style="background-color:#aaed9f ; height:50px">
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <h2><b>Pixel Surf</b></h2>
                </a>

                <form class="d-flex" id="searchform">
                    <input class="form-control me-2" type="search" id="search" placeholder="looking for someone.." style="height:40px;margin-top:7px;"
