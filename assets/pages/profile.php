    ...
    <div class="container col-md-9 col-sm-11 rounded-0">
        ...
        <div className="profileCover">
              <img
                ...
                src="C:\xampp\htdocs\dbms-pro\assets\images\posts\16708374454.jpg"
                alt=""
              />
...
<a class="btn btn-sm btn-success"><i class="bi bi-file-post-fill"></i> <?=count($profile_post)?> Posts</a>
<a class="btn btn-sm btn-success <?=count($profile['followers'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#follower_list"><i class="bi bi-people-fill"></i> <?=count($profile['followers'])?> Followers</a>
<a class="btn btn-sm btn-success <?=count($profile['following'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#following_list"><i class="bi bi-person-fill"></i> <?=count($profile['following'])?> Following</a>
...
<button class="btn btn-sm btn-danger unfollowbtn" data-user-id='<?=$profile['id']?>' >unfollow</button>
   ...
   <?php
    ...
    ?>
<button class="btn btn-sm btn-primary followbtn" data-user-id='<?=$profile['id']?>' >Request Follow</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-md-flex p-0">
                    <div class="col-md-8 col-sm-12">
                        <img src="assets/images/posts/<?=$post['post_img']?>" style="max-height:110vh;" class="w-100 rounded-start">
                    </div>
