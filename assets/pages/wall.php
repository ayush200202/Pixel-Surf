...
foreach($posts as $post){
    ...
    ?>
     <div class="card mt-4" style="background-color:#d2edf6 ; width: 600px;margin-left:100px">
...
if($post['uid']==$user['id']){
  ...
  <ul class="dropdown-menu" aria-labelledby="option<?=$post['id']?>">
    ...
    <?php
                ...
                <img src="assets/images/posts/<?=$post['post_img']?>" loading=lazy class="" alt="..." style="margin-left:10px;margin-right:10px; ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-md-flex p-0">
                    <div class="col-md-8 col-sm-12">
                        <img src="assets/images/posts/<?=$post['post_img']?>" style="" class="w-100 overflow:hidden">
                    </div>
